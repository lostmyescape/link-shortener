...
func (x *ValidateUserRequest) GetUid() int32 {
	if x != nil {
		return x.Uid
	}
	return 0
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x03uid\x18\x01 \x01(\x05R\x03uid\"D\n" +
	"\x14ValidateUserResponse\x12\x16\n" +
	"\x06exists\x18\x01 \x01(\bR\x06exists\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email2\xf2\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponse\x12E\n" +
	"\fValidateUser\x12\x19.auth.ValidateUserRequest\x1a\x1a.auth.ValidateUserResponseB\x1bZ\x19lostmyescape.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	6, // 3: auth.Auth.ValidateUser:input_type -> auth.ValidateUserRequest
	...
	7, // 7: auth.Auth.ValidateUser:output_type -> auth.ValidateUserResponse
